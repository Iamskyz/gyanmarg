...
const seedClass10Odia = async () => {
  try {
    ...
    await Question.insertMany([
      ...
      { quiz: odiaQuiz3._id, questionText: "In board exams, what is the word limit for Odia essay?", options: ["50-80", "100-150", "200-300", "500+"], correctAnswer: 2, marks: 1, explanation: "Odia essays in board exams are typically 200-300 words." },
      ...
      { quiz: odiaQuiz3._id, questionText: "What is 'Anuched Lekhan' in board exams?", options: ["Story writing", "Paragraph writing on given topic (80-100 words)", "Letter writing", "Poetry"], correctAnswer: 1, marks: 1, explanation: "Anuched Lekhan is writing a single paragraph on a given topic." },
      ...
      { quiz: odiaQuiz3._id, questionText: "What is 'Pratibedan' (report) writing for newspapers?", options: ["Fiction", "Factual account of an event with 5W+1H", "Poetry", "Personal diary"], correctAnswer: 1, marks: 1, explanation: "News report covers Who, What, When, Where, Why, and How of an event." },
    ...
    console.log("✓ Class 10 - Odia (English): 3 quizzes, 30 questions created");
...
export default seedClass10Odia;

...
// Full Odia translated Class 10 Odia file with all 30 questions
...
const seedClass10OdiaOdia = async () => {
  try {
    ...
    await Question.insertMany([
      ...
      { quiz: odiaQuiz3._id, questionText: "Board exam ରେ ଓଡ଼ିଆ ନିବନ୍ଧର word limit କେତେ?", options: ["50-80", "100-150", "200-300", "500+"], correctAnswer: 2, marks: 1, explanation: "ସାଧାରଣତଃ 200-300 ଶବ୍ଦ।" },
    ...
    console.log("✓ Class 10 - Odia: 3 quizzes, 30 questions created");
...
export default seedClass10OdiaOdia;

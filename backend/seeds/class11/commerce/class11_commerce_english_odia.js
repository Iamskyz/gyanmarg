...
const seedClass11CommerceEnglishOdia = async () => {
  try {
    ...
    console.log("✓ Class 11 Commerce - English Odia: 3 quizzes, 30 questions created");
...
export default seedClass11CommerceEnglishOdia;

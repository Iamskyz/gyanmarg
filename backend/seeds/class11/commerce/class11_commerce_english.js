...
const seedClass11CommerceEnglish = async () => {
  try {
    ...
    await Question.insertMany([
      ...
      { quiz: engQuiz1._id, questionText: "'Unless' means:", options: ["If", "If not", "Although", "Because"], correctAnswer: 1, marks: 1, explanation: "'Unless' = 'if not'. Example: Unless you study, you will fail." },
      ...
      { quiz: engQuiz1._id, questionText: "'Had I known, I would have helped.' This is:", options: ["Type 1 conditional", "Type 2 conditional", "Type 3 conditional (inverted)", "Zero conditional"], correctAnswer: 2, marks: 1, explanation: "Type 3 conditional with inversion: Had + subject + past participle." },
      ...
      { quiz: engQuiz1._id, questionText: "Zero conditional is used for:", options: ["Unlikely situations", "General truths and facts", "Past regrets", "Future plans"], correctAnswer: 1, marks: 1, explanation: "Zero conditional: If + present, present. Used for facts." },
      ...
      { quiz: engQuiz1._id, questionText: "Non-defining relative clause:", options: ["Is essential for meaning", "Adds extra information, uses commas", "Uses 'that'", "Has no pronoun"], correctAnswer: 1, marks: 1, explanation: "Non-defining clauses add extra info and are set off by commas." },
    ...
    await Question.insertMany([
      ...
      { quiz: engQuiz3._id, questionText: "What is 'blank verse'?", options: ["Poetry with no meaning", "Unrhymed iambic pentameter", "Free verse", "Rhyming couplets"], correctAnswer: 1, marks: 1, explanation: "Blank verse is unrhymed poetry in iambic pentameter." },
      ...
      { quiz: engQuiz3._id, questionText: "'Catharsis' in tragedy means:", options: ["Comedy", "Emotional purification of audience", "Plot twist", "Happy ending"], correctAnswer: 1, marks: 1, explanation: "Catharsis is the emotional release the audience feels through pity and fear." },
      ...
      { quiz: engQuiz3._id, questionText: "A 'monologue' is:", options: ["Two people talking", "One person's long speech", "A song", "A dance"], correctAnswer: 1, marks: 1, explanation: "A monologue is a long speech by one character." },
      { quiz: engQuiz3._id, questionText: "What is 'iambic pentameter'?", options: ["5 stressed syllables per line", "10 syllables with alternating unstressed/stressed pattern", "Free verse", "Rhyming pattern"], correctAnswer: 1, marks: 1, explanation: "Iambic pentameter: 10 syllables per line in unstressed-stressed pattern." },
      { quiz: engQuiz3._id, questionText: "A 'ballad' is:", options: ["A long novel", "A narrative poem/song telling a story", "An essay", "A drama"], correctAnswer: 1, marks: 1, explanation: "A ballad is a narrative poem or song that tells a story." },
    ]);

    console.log("✓ Class 11 Commerce - English: 3 quizzes, 30 questions created");
...
export default seedClass11CommerceEnglish;
